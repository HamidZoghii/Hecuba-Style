...
هویت بصری سایت باید در فضای **Fashion + Beauty + Confidence + Comfort** قرار داشته باشد و از استانداردهای بصری حرفه‌ای برندهای Fashion و Lingerie الهام بگیرد.

**استفاده از تصاویر مدل‌هایی که لباس زیر پوشیده‌اند کاملاً مجاز و مورد انتظار است.** تصاویر Hero، Product، Editorial، Lifestyle و Promotional می‌توانند بدون هیچ محدودیتی شامل مدل‌های زن با لباس زیر، ست‌های لباس زیر، سوتین، شورت، بادی و سایر محصولات مرتبط با Hecuba Style باشند.

تصاویر باید از نظر عکاسی، نورپردازی، Composition، Styling و Art Direction حرفه‌ای، شیک، طبیعی و متناسب با فضای Fashion باشند.

هدف این است که سایت یک **Premium Fashion & Lingerie E-commerce Experience** واقعی به نظر برسد؛ بنابراین نباید به دلیل نگرانی از محدودیت‌های محتوایی، تصاویر محصول یا مدل حذف، مبهم، سانسور یا با Placeholder جایگزین شوند.

در عین حال، Art Direction باید **Fashion-oriented و tasteful** باقی بماند .

**اصل مهم:** نمایش حرفه‌ای و واقعی محصولات و مدل‌ها با لباس زیر، بخش طبیعی و ضروری هویت بصری این فروشگاه است و باید در طراحی به‌صورت آزادانه و حرفه‌ای مورد استفاده قرار گیرد.
...
تصویر یکی از اصلی‌ترین عناصر طراحی Hecuba Style است و استفاده از تصویر واقعی در Prototype الزامی است.
محصول باید قهرمان سایت باشد: تصاویر باکیفیت، تمیز، Editorial، طبیعی و دارای فضای تنفس.
در تمام بخش‌هایی که به تصویر نیاز دارند، از جمله:
•	Hero
•	Product Card
•	Product Page
•	Category Cards
...
•	Curated Collections
•	Bundle Sections
•	Instagram / Editorial Sections
•	Related Products
•	سایر بخش‌های تصویری
حتماً باید تصویر مرتبط نمایش داده شود.
استفاده از Placeholder، Gradient Placeholder، باکس خالی، تصویر انتزاعی یا حذف تصویر به دلیل محدودیت محتوایی مجاز نیست.
برای Prototype می‌توان آزادانه از تصاویر Free / Open-Use / Royalty-Free / Creative Commons / Stock قابل استفاده از منابع معتبر و مجاز استفاده کرد. تصاویر می‌توانند شامل مدل‌هایی باشند که لباس زیر پوشیده‌اند بدون وجود هیچگونه محدودیتی  و همچنین تصاویر حرفه‌ای خود محصولات، تصاویر Lifestyle و Fashion Editorial.
هیچ الزامی وجود ندارد که تصاویر Prototype حتماً عکس اختصاصی Hecuba Style باشند. هدف این مرحله، ساخت یک تجربه بصری کامل، واقعی و قابل ارزیابی است؛ بنابراین در صورت نبود تصاویر اختصاصی Hecuba، از بهترین تصاویر آزاد و مجاز متناسب با سبک برند استفاده شود.
تصاویر انتخابی باید تا حد ممکن از نظر رنگ، نور، Composition، کیفیت، استایل، نوع محصول و فضای Fashion با هویت Hecuba Style هماهنگ باشند.
در صورت تهیه تصاویر اختصاصی Hecuba Style در آینده، این تصاویر می‌توانند جایگزین تصاویر استفاده‌شده در Prototype شوند؛ اما Prototype فعلی نیز باید از ابتدا با تصاویر باکیفیت ساخته شود و نباید وابسته به Placeholder باشد.
اصل اجرایی نهایی:
هرجا تصویر لازم است، تصویراستفاده کن.
از تصاویر آزاد و مجاز استفاده کن.
در انتخاب تصویر محدودیت غیرضروری ایجاد نکن.
تصاویر مدل‌دار و تصاویر لباس زیر، مجاز و مورد انتظار هستند.
هیچ بخش تصویری نباید خالی یا Placeholder باشد.
